    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(getBaseContext(), CongressionalView.class);
        ...
        mCurrBttn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent sendIntent = new Intent(getBaseContext(), PhoneToWatchService.class);
                sendIntent.putExtra("ZIP_CODE", "94709");
                startService(sendIntent);
                Intent intent2 = new Intent(getBaseContext(), CongressionalView.class);
